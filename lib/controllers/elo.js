...
async function recalculateAll() {
  try {
    ...
    // Replay all matches — also track biggest upset and weekly ELO snapshots
    ...
    try {
      await db.query(
        `UPDATE global_stats SET biggest_upset_underdog = $1, biggest_upset_favorite = $2, biggest_upset_elo_diff = $3, weekly_top_name = $4, weekly_top_gain = $5 WHERE id = 1`,
        [biggestUpset ? biggestUpset.underdog : null, biggestUpset ? biggestUpset.favorite : null, biggestUpset ? biggestUpset.eloDiff : 0, weeklyTopName, Math.round(weeklyTopGain)]
      );
