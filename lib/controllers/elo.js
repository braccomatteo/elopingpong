...
async function recalculateAll() {
  try {
    ...
    for (const id of playerIds) {
      ...
      await db.query(
        'UPDATE players SET score_overall = $1, score_1v1_21 = $2, score_1v1_11 = $3, score_2v2_21 = $4, score_2v2_11 = $5, games_1v1_21 = $6, games_1v1_11 = $7, games_2v2_21 = $8, games_2v2_11 = $9 WHERE id = $10',
        [overall, s.score_1v1_21, s.score_1v1_11, s.score_2v2_21, s.score_2v2_11, catCounts[id].games_1v1_21, catCounts[id].games_1v1_11, catCounts[id].games_2v2_21, catCounts[id].games_2v2_11, id]
      );
    }
