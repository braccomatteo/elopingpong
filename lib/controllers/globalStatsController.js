  ...
  try {
    ...
    const avgEloByCompany = await db.query(`
      SELECT company,
        ...
        ROUND(AVG(CASE WHEN games_1v1_21 > 0 THEN score_1v1_21 END)) as avg_1v1_21,
        ROUND(AVG(CASE WHEN games_1v1_11 > 0 THEN score_1v1_11 END)) as avg_1v1_11,
        ROUND(AVG(CASE WHEN games_2v2_21 > 0 THEN score_2v2_21 END)) as avg_2v2_21,
        ROUND(AVG(CASE WHEN games_2v2_11 > 0 THEN score_2v2_11 END)) as avg_2v2_11,
        COUNT(*) as player_count,
        SUM(CASE WHEN games_1v1_21 > 0 THEN 1 ELSE 0 END) as count_1v1_21,
        SUM(CASE WHEN games_1v1_11 > 0 THEN 1 ELSE 0 END) as count_1v1_11,
        SUM(CASE WHEN games_2v2_21 > 0 THEN 1 ELSE 0 END) as count_2v2_21,
        SUM(CASE WHEN games_2v2_11 > 0 THEN 1 ELSE 0 END) as count_2v2_11
      FROM players
      WHERE deleted_at IS NULL AND approved = TRUE AND name != 'Admin'
        AND company IS NOT NULL AND company != ''
        AND (games_1v1_21 + games_1v1_11 + games_2v2_21 + games_2v2_11) > 0
    ...
    res.json({
      ...
      avgEloByCompany: avgEloByCompany.rows.map(r => ({
        ...
        avgElo_1v1_21: r.avg_1v1_21 != null ? parseInt(r.avg_1v1_21) : null,
        avgElo_1v1_11: r.avg_1v1_11 != null ? parseInt(r.avg_1v1_11) : null,
        avgElo_2v2_21: r.avg_2v2_21 != null ? parseInt(r.avg_2v2_21) : null,
        avgElo_2v2_11: r.avg_2v2_11 != null ? parseInt(r.avg_2v2_11) : null,
        playerCount: parseInt(r.player_count),
        playerCount_1v1_21: parseInt(r.count_1v1_21),
        playerCount_1v1_11: parseInt(r.count_1v1_11),
        playerCount_2v2_21: parseInt(r.count_2v2_21),
        playerCount_2v2_11: parseInt(r.count_2v2_11),
      })),
